 ...
 * @author Matej
 */
public class CreateParametersFilleB01 {
    public static void main(String args[]){
        ...
        try{
            FileWriter fw = null;
             fw = new FileWriter("F:\\Matej Dokumenti\\Redescription mining with CLUS\\OtherDPRMAlgos\\SettingsFilesRev2\\"+"parametersNPASB01"+".txt");
               ...
               if(i!=0 && i!=2)
                ...
                for(int j=0;j<10;j++){
                    if(i==0){
                        ...
                        String set = "SettingsNPASRev2B01_"+(j+1)+"A0S0.set";
                        //String set = "SettingsMammalsRev2B01_"+(j+1)+"A0S0.set";
                        //String set = "SettingsMIMICRev2B01_"+(j+1)+"A0S0.set";
                         //String set = "SettingsCMS2_4Rev2B01_"+(j+1)+"A0S0.set";
                        // String set = "SettingsCMS2_8Rev2B01_"+(j+1)+"A0S0.set";
                         //String set = "SettingsCMS2_16Rev2B01_"+(j+1)+"A0S0.set";
                        fw.write(set);
                        fw.write(" "+0+" "+(j+1)+"\n");
                    }
                    else if(i==1){
                        ...
                        String set = "SettingsCMS2_4Rev2B01_"+(j+1)+"A0S1.set";
                        //String set = "SettingsCMS2_8Rev2_"+(j+1)+"A0S1.set";
                        //String set = "SettingsCMS2_1Rev2B01_"+(j+1)+"A0S1.set";
                        fw.write(set);
                        fw.write(" "+0+" "+(j+1)+"\n");
                    }
                    else if(i==2){
                        //String set = "SettingsCMS2_1Rev2_"+(j+1)+"A1S0.set";
                        String set = "SettingsNPASRev2B01_"+(j+1)+"A1S0.set";
                       // String set = "SettingsMammalsRev2B01_"+(j+1)+"A1S0.set";
                        //String set = "SettingsMIMICRev2B01_"+(j+1)+"A1S0.set";
                       // String set = "SettingsCMS2_4Rev2B01_"+(j+1)+"A1S0.set";
                       // String set = "SettingsCMS2_8Rev2B01_"+(j+1)+"A1S0.set";
                       // String set = "SettingsCMS2_16Rev2B01_"+(j+1)+"A1S0.set";
                        fw.write(set);
                        fw.write(" "+1+" "+(j+1)+"\n");
                    }
                    else if(i==3){
                        ...
                        // String set = "SettingsMammalsRev2_"+(j+1)+"A1S1.set";
                         ...
                         String set = "SettingsCMS2_4Rev2B01_"+(j+1)+"A1S1.set";
                        // String set = "SettingsCMS2_8Rev2_"+(j+1)+"A1S1.set";
                       //  String set = "SettingsCMS2_1Rev2B01_"+(j+1)+"A1S1.set";
                        fw.write(set);
                        fw.write(" "+1+" "+(j+1)+"\n");
                    }
                     else if(i==4){
                        ...
                        // String set = "SettingsCMS2_8Rev2_"+(j+1)+"A2B0.set";
                         String set = "SettingsCMS2_1Rev2B01_"+(j+1)+"A2B0.set";
                        fw.write(set);
                        fw.write(" "+0+" "+(j+1)+"\n");
                    }
                     else if(i==5){
                         ...
                         String set = "SettingsCMS2_1Rev2B01_"+(j+1)+"A2B1.set";
                        fw.write(set);
                        fw.write(" "+0+" "+(j+1)+"\n");
                    }
                }
