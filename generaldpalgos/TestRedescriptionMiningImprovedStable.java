 ...
 * @author Matej
 */
public class TestRedescriptionMiningImprovedStable {
    ...
    public static void main(String args[]){
        ...
        try{
                ...
                int numInitTrials = set.numInitTrials;
                 ...
                 numInitTrials = Math.min(numInitTrials, numAttrs+numAttrs1);
                
                
                double epsilon = set.budget/(numInitTrials*(((double)numIterations)*2+1));
                //divide by 2*numIterations+1
        ...
        for(int initTrial = 0;initTrial<numInitTrials;initTrial++){   
            System.out.println("Initial trial: "+(initTrial+1));
               if(algo == 0)
            ...
            try{
             for(int it=0;it<=numIterations;it++){
              ...
              System.out.println("Redescription creation time: "+elapsedTime/(1000.0)+"s");
                ...
                e.printStackTrace();
                System.out.println("Failed initialzation, moving on..."+initTrial+"/"+numInitTrials);
                continue;
            }
        }
